                ...
                <form method="POST" wire:submit.prevent="update">
                    <div class="row">
                        <div class="col-sm-6 my-2">
                            ...
                            <input type="text" class="form-control @error('servidor.nome') is-invalid @enderror" wire:model.lazy="servidor.nome" placeholder="Digite o nome servidor">
                    ...
                    <div class=" my-3 float-end ">
                        ...
                        <button wire:click="update" type="submit" class="btn btn-success btn-fixed-size" wire:loading.attr="disabled">
                            {{-- Texto padrão do botão--}}
                            <span wire:click="update" wire:loading.remove.delay.shortest>Salvar</span>
                            {{-- Efeito de carregamento quando o butão é acionado--}}
                            <span wire:click="update" wire:loading.delay.shortest class="spinner-border spinner-border-sm text-white" role="status"></span>
                        </button>
                    </div>
                </form> 
            </div>
